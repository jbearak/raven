...
> **Developing an R package?** See [R Package Development](r-package-dev.md) for how Raven handles `R/*.R` mutual visibility, roxygen annotations, and NAMESPACE imports.
