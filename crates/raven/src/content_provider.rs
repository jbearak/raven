    ...
    async fn test_default_provider_get_artifacts_open_doc_precedence() {
        ...
        index_artifacts.exported_interface.insert(
            ...
            crate::cross_file::scope::ScopedSymbol {
                ...
                defined_line: 0,
                defined_column: 0,
                defined_end_column: crate::utf16::utf16_len("workspace_func"),
                signature: None,
                is_declared: false,
            },
        );
            ...
            rt.block_on(async {
                ...
                index_artifacts.exported_interface.insert(
                    ...
                    crate::cross_file::scope::ScopedSymbol {
                        ...
                        defined_line: 0,
                        defined_column: 0,
                        defined_end_column: crate::utf16::utf16_len(&index_func),
                        signature: None,
                        is_declared: false,
                    },
                );
            ...
            rt.block_on(async {
                ...
                artifacts.exported_interface.insert(
                    ...
                    crate::cross_file::scope::ScopedSymbol {
                        ...
                        defined_line: 1,
                        defined_column: 0,
                        defined_end_column: crate::utf16::utf16_len(&func_name),
                        signature: None,
                        is_declared: false,
                    },
                );
...
mod integration_tests {
    ...
    async fn test_cross_file_resolution() {
        ...
        utils_artifacts.exported_interface.insert(
            ...
            crate::cross_file::scope::ScopedSymbol {
                ...
                defined_line: 0,
                defined_column: 0,
                defined_end_column: crate::utf16::utf16_len("helper_func"),
                signature: None,
                is_declared: false,
            },
        );
    ...
    async fn test_workspace_index_declared_symbols_available_in_scope() {
        ...
        let declared_func = ScopedSymbol {
            ...
            defined_line: 1,
            defined_column: 0,
            defined_end_column: crate::utf16::utf16_len("declared_func"),
            signature: None,
            is_declared: true,
        };
        artifacts.timeline.push(ScopeEvent::Declaration {
    ...
    async fn test_opened_file_reextracts_declared_symbols() {
        ...
        let old_symbol = ScopedSymbol {
            ...
            defined_line: 0,
            defined_column: 0,
            defined_end_column: crate::utf16::utf16_len("old_declared"),
            signature: None,
            is_declared: true,
        };
    ...
    async fn test_scope_resolution_uses_indexed_file_declarations() {
        ...
        let child_declared = ScopedSymbol {
            ...
            defined_line: 0,
            defined_column: 0,
            defined_end_column: crate::utf16::utf16_len("child_declared"),
            signature: None,
            is_declared: true,
        };
