...
- [x] 1. Implement BlockDetector with regex patterns and brace matching
  - [x] 1.1 Add `BlockDetector` struct and static regex patterns to `handlers.rs`
  ...
  - [x] 1.2 Implement `find_matching_brace` with comment/string-aware state machine
  ...
  - [x] 1.3 Write unit tests for BlockDetector JAGS detection
  ...
  - [x] 1.4 Write unit tests for BlockDetector Stan detection
  ...
  - [x] 1.5 Write unit tests for brace matching edge cases
...
- [x] 2. Integrate BlockDetector into document_symbol handler
  - [x] 2.1 Modify `document_symbol` to dispatch based on `FileType`
  ...
  - [x] 2.2 Write unit tests for file type dispatch and hierarchical nesting
...
- [x] 3. Checkpoint
  - All tests pass: 2890 unit + 103 integration + 59 doc tests, 0 failures.

- [x] 4. Property-based tests for correctness properties
  - [x] 4.1 Write property test for block keyword detection
  ...
  - [x] 4.2 Write property test for block range correctness
  ...
  - [x] 4.3 Write property test for selection range correctness
  ...
  - [x] 4.4 Write property test for symbol nesting
  ...
  - [x] 4.5 Write property test for file type dispatch
  ...
  - [x] 4.6 Write property test for brace matching in comments/strings
...
- [x] 5. Update documentation
  - [x] 5.1 Update `docs/document-outline.md` with JAGS/Stan block detection
