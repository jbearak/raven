...
- [ ] 1. Implement BackgroundIndexer core infrastructure
  - [ ] 1.1 Create BackgroundIndexer struct
...
- [ ] 2. Implement file indexing logic
  - [ ] 2.1 Implement index_file() static method
  ...
  - [ ] 2.2 Implement process_task() static method
  ...
  - [ ] 2.3 Implement queue_transitive_deps() static method
...
- [ ] 3. Integrate BackgroundIndexer with Backend
  - [ ] 3.1 Add background_indexer field to Backend
    - Add Arc<BackgroundIndexer> field
    - Initialize in Backend::new()
    - Pass state Arc to BackgroundIndexer
    - _Requirements: 4.4_
  
  - [ ] 3.2 Modify did_open() to submit Priority 2 tasks
  ...
  - [ ] 3.3 Keep existing Priority 1 synchronous indexing
    - No changes to Priority 1 logic
    - Ensure Priority 1 completes before diagnostics
    - _Requirements: 5.4_

- [ ] 4. Add configuration options
  - [ ] 4.1 Add on-demand indexing fields to CrossFileConfig
...
- [ ] 6. Add unit tests
  - [ ] 6.1 Test BackgroundIndexer::submit()
  ...
  - [ ] 6.2 Test IndexTask ordering
    - Test priority comparison
    - Test tasks with same priority (FIFO)
    - Test depth tracking
    - _Requirements: 3.1_
  
  - [ ] 6.3 Test queue_transitive_deps()
    - Test depth limiting
...
- [ ] 7. Add integration tests
  - [ ] 7.1 Test Priority 2 indexing end-to-end
  ...
  - [ ] 7.2 Test Priority 3 indexing end-to-end
...
- [ ] 10. Final validation and testing
  ...
  - [ ] 10.2 Test with real VS Code extension
